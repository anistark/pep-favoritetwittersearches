package com.stark.favoritetwittersearches;
...
public class FavoriteTwitterSearchesActivity extends Activity {
	...
	public OnClickListener saveButtonListener = new OnClickListener()
	{
		...
		public void onClick(View v)
		{
			...
			else
			{
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(FavoriteTwitterSearchesActivity.this);
